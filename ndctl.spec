...
Version  : 63
Release  : 37
URL      : https://github.com/pmem/ndctl/archive/v63.tar.gz
Source0  : https://github.com/pmem/ndctl/archive/v63.tar.gz
Summary  : Manage "libnvdimm" subsystem devices (Non-volatile Memory)
Group    : Development/Tools
License  : CC0-1.0 GPL-2.0 LGPL-2.1 MIT
Requires: ndctl-bin
Requires: ndctl-config
Requires: ndctl-lib
Requires: ndctl-data
...
Requires: ndctl-config = %{version}-%{release}
...
%package config
Summary: config components for the ndctl package.
Group: Default

%description config
config components for the ndctl package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1538840755
...
/usr/share/doc/ndctl/Documentation_copyright.txt
